                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select id="kelas" name="kelas"
                                                        ...
                                                        <option value="-"
                                                            ...
                                                            -</option>
                                                        <option value="1"
                                                            {{ $item->kelas == '1' ? 'selected' : '' }}>
                                                            1</option>
                                                        <option value="2"
                                                            {{ $item->kelas == '2' ? 'selected' : '' }}>
                                                            2</option>
                                                        <option value="3"
                                                            {{ $item->kelas == '3' ? 'selected' : '' }}>
                                                            3</option>
                                                        <option value="4"
                                                            {{ $item->kelas == '4' ? 'selected' : '' }}>
                                                            4</option>
                                                        <option value="5"
                                                            {{ $item->kelas == '5' ? 'selected' : '' }}>
                                                            5</option>
                                                        <option value="6"
                                                            {{ $item->kelas == '6' ? 'selected' : '' }}>
                                                            6</option>
                                                        <option value="7"
                                                            {{ $item->kelas == '7' ? 'selected' : '' }}>
                                                            7</option>
                                                        <option value="8"
                                                            {{ $item->kelas == '8' ? 'selected' : '' }}>
                                                            8</option>
                                                        <option value="9"
                                                            {{ $item->kelas == '9' ? 'selected' : '' }}>
                                                            9</option>
                                                        <option value="11"
