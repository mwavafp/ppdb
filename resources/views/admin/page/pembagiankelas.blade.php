<x-layoute>
    ...
    <div class="px-9 py-5 flex items-center mb-4">
        <h1 class="font-bold text-xl mr-4">PEMBAGIAN KELAS</h1>
    ...
    <form method="GET" action="{{ route('pembagiankelas.filter') }}">
        <div class="max-w-7xl  bg-white px-8 my-8">
                                        ...
                                        <form action="{{ route('pembagiankelas.update', $item->id_kelas) }}"
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select id="kls_identitas" name="kls_identitas"
                                                    ...
                                                    <option value="B"
                                                        {{ $item->kls_identitas == 'B' ? 'selected' : '' }}>B</option>
                                                    <option value="C"
                                                        {{ $item->kls_identitas == 'C' ? 'selected' : '' }}>C</option>
                                                    <option value="D"
                                                        {{ $item->kls_identitas == 'D' ? 'selected' : '' }}>D</option>
                                                    <option value="E"
                                                        {{ $item->kls_identitas == 'E' ? 'selected' : '' }}>E</option>
                                                    <option value="F"
                                                        {{ $item->kls_identitas == 'F' ? 'selected' : '' }}>F</option>
                                                </select>
                                            </div>
