    ...
    <div class="bg-white w-96 p-6 rounded shadow">
      ...
      <form id="editForm">
        <div class="mb-4">
          ...
          <input type="text" id="no" class="w-full p-2 border border-gray-300 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
          <label for="nama" class="block text-sm font-medium">Nama</label>
          <input type="text" id="nama" class="w-full p-2 border border-gray-300 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
          <label for="nisn" class="block text-sm font-medium">NISN</label>
          <input type="text" id="nisn" class="w-full p-2 border border-gray-300 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
          <label for="jenjang" class="block text-sm font-medium">Jenjang</label>
          <input type="text" id="jenjang" class="w-full p-2 border border-gray-300 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
          <label for="kelas" class="block text-sm font-medium">Kelas</label>
          <input type="text" id="kelas" class="w-full p-2 border border-gray-300 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
