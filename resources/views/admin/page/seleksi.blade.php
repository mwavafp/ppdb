            ...
            <table class="min-w-full divide-y divide-gray-200" id="dataTable">
                <thead class="bg-[oklch(62.7%_0.194_149.214)] text-white border-b-2">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium uppercase tracking-wider">Status Seleksi
                        </th>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status_user" name="status" class="form-select">
                                            ...
                                            <option value="tidak_aktif"
                                                {{ $student->status_user == 'Tidak Aktif' ? 'selected' : '' }}>Tidak
                                                Aktif
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status_seleksi" name="status_seleksi" class="form-select">
                                            <option value="LOLOS"
                                                {{ $student->status_seleksi == 'LOLOS' ? 'selected' : '' }}>LOLOS
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status_ijazah_akhir" name="status_ijazah_akhir"
                                            class="form-select">
                                            <option value="diserahkan"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status_kip" name="status_kip" class="form-select">
                                            ...
                                            <option value="belum_diserahkan"
                                                {{ $student->status_kip == 'belum_diserahkan' ? 'selected' : '' }}>
                                                Belum
                                                Diserahkan</option>
                                        </select>
                                    </div>
