    ...
    <body class="bg-white text-gray-900 overflow-x-hidden">
        ...
        <header class="mb-10 max-w-full">
            <div class="container flex flex-col max-w-full">
                ...
                <p class="text-sm text-gray-500 mt-1">Halaman SMA</p>
            </div>
        </header>

        <!-- Form Section -->
        <div class="bg-white px-7 pb-7 pt-1 rounded-lg shadow-lg max-w-full">
            <form method="POST" action="{{ route('pengaturansma-update') }}" enctype="multipart/form-data"
                ...
                <div id="gambar-deskripsi " class="mb-8">
                    <div class="w-full">
                        ...
                        <div class="py-4">
                            ...
                            <img class="rounded-xl" src="{{ asset('storage/' . $data->image_sma) }}" alt=""
                                width="400">
                        </div>
                        <div>
                            <p>Edit Photo</p>
                            <input type="file" name="image_sma" id=""
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex flex-wrap">
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sma_a) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sma_a" id=""
                            ...
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sma_b) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sma_b" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    ...
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sma_c) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sma_c" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sma_d) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sma_d" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sma_e) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sma_e" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sma_f) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sma_f" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                        </div>
