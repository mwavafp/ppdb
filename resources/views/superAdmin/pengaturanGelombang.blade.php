            ...
            <tbody>
                @forelse ($acara as $gelombang)
                    <tr class="border-b text-center">
                        ...
                        <td class="py-2 px-4">
                            <button class="text-blue-500 hover:underline" onclick="openEditModal(this)"
                                data-id="{{ $gelombang->id_acara }}" data-nama="{{ $gelombang->namaAcara }}"
                                data-status="{{ $gelombang->status }}" data-awal="{{ $gelombang->awal_acara }}"
