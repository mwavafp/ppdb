<x-layout>
    <x-slot:title>Pengaturan Informasi TK</x-slot:title>

    <title>Pengaturan Informasi TK</title>
    ...
    <body class="bg-white text-gray-900">
        <div class="container mx-auto px-6 py-12">
            ...
            <div class="bg-primary text-white text-center py-6 mb-12 rounded-lg shadow-md">
                <h1 class="text-3xl font-semibold">Pengaturan Informasi TK</h1>
            </div>

            <!-- Form Section -->
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <form method="POST" action="{{ route('pengaturantk-update') }}" class="space-y-8">
                    @csrf
