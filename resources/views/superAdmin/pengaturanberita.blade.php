                ...
                @else
                    @foreach ($all_teks as $item)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="border px-4 py-2 text-center text-[10px] truncate max-w-[200px]" title="{{ $item->judul }}">{{ $item->judul }}</td>
                            {{-- <td class="border px-4 py-2 text-center text-[10px] truncate max-w-[200px]" title="{{ $item->abstrak }}">{{ $item->abstrak }}</td> --}}
                            <td class="border px-4 py-2 text-center text-[10px] truncate max-w-[200px]" title="{{ $item->isi }}">{{ $item->isi }}</td>
                            <td class="border px-4 py-2 text-center text-sm">{{ $item->nama }}</td>
                            <td class="border px-4 py-2 text-center text-sm">{{ $item->unit }}</td>
                            <td class="border px-4 py-2 text-center text-sm">{{ $item->gambar }}</td>
