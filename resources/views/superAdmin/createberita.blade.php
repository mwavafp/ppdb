...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <header class="mb-10">
                <div class="container flex flex-col">
                    <h1 class="text-3xl font-bold break-words">Tambah Berita</h1>
                </div>
            </header>
    <div class="bg-white px-4 sm:px-7 pb-7 pt-1 rounded-lg shadow-lg w-full">
        ...
        <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" id="judul" class="w-full border px-3 py-2 rounded" required>
            </div>

            <div class="mb-4">
                <label for="abstrak" class="block font-medium">Abstrak</label>
                <textarea name="abstrak" id="abstrak" rows="3" class="w-full border px-3 py-2 rounded"></textarea>
            </div>

            <div class="mb-4">
                <label for="isi" class="block font-medium">Isi</label>
                <textarea name="isi" id="isi" rows="5" class="w-full border px-3 py-2 rounded" required></textarea>
            </div>
           ...
           hover:file:bg-green-400">
            ...
            <div class="flex justify-end space-x-2">
                <a href="{{ route('pengaturanberita') }}" class="bg-gray-500 text-white px-4 py-2 rounded">Batal</a>
