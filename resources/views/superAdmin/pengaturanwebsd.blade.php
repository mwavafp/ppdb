<x-layoute>
    ...
    <body class="bg-white text-gray-900 overflow-x-hidden">
        ...
        <div class="bg-white px-7 pb-7 pt-1 rounded-lg shadow-lg max-w-full">
            <form method="POST" action="{{ route('pengaturansd-update') }}" enctype="multipart/form-data"
                ...
                <div id="gambar-deskripsi " class="mb-8">
                    <div class="w-full">
                        ...
                        <div class="py-4">
                            ...
                            <img class="rounded-xl" src="{{ asset('storage/' . $data->image_sd) }}" alt=""
                                width="400">
                        </div>
                        <div>
                            <p>Edit Photo</p>
                            <input type="file" name="image_sd" id=""
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex flex-wrap">
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sd_a) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sd_a" id=""
                            ...
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sd_b) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sd_b" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    ...
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sd_c) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sd_c" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sd_d) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sd_d" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sd_e) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sd_e" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                            <div class="py-4">
                                ...
                                <div>
                                    <img class="rounded-xl" src="{{ asset('storage/' . $data->gallery_sd_f) }}"
                                        alt="" width="200">
                                </div>
                                <div>
                                    <p>Edit Photo</p>
                                    <input type="file" name="gallery_sd_f" id=""
                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-[oklch(62.7%_0.194_149.214)] file:text-white hover:file:bg-green-400">
                                </div>
                            </div>
                        </div>
