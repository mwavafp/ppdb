@if (Auth::user()->role == 'admin')
    @php
        $menu = [
            ...
            (object) ['menu' => (object) ['icon' => 'fa-file-invoice-dollar', 'title' => 'Tagihan Pendaftar', 'link' => 'tagihan-admin']],
            (object) ['menu' => (object) ['icon' => 'fa-users', 'title' => 'Data Pendaftar', 'link' => 'siswa']],
            (object) ['menu' => (object) ['icon' => 'fa-user-check', 'title' => 'Seleksi Pendaftar', 'link' => 'seleksiSiswa']],
            (object) ['menu' => (object) ['icon' => 'fa-graduation-cap', 'title' => 'Pembagian Kelas', 'link' => 'pembagiankelas']],
        ];
    @endphp
@else
    @php
        $menu = [
            (object) ['menu' => (object) ['icon' => 'fa-house', 'title' => 'Dashboard Super Admin', 'link' => 'dashboard-super-admin']],
            (object) ['menu' => (object) ['icon' => 'fa-users', 'title' => 'Data User Admin', 'link' => 'data-admin']],
            (object) ['menu' => (object) ['icon' => 'fa-user-check', 'title' => 'Tahun Ajaran Pengaturan', 'link' => 'tahun-ajaran-pengaturan']],
            (object) ['menu' => (object) ['icon' => 'fa-calendar', 'title' => 'Pengaturan Gelombang', 'link' => 'pengaturan-gelombang']],
            (object) ['menu' => (object) ['icon' => 'fa-file-invoice-dollar', 'title' => 'Pengaturan Biaya Daftar', 'link' => 'pengaturan-biaya-daftar']],
            (object) ['menu' => (object) ['icon' => 'fa-wrench', 'title' => 'Pengaturan Website', 'link' => 'pengaturan-website']],
            (object) ['menu' => (object) ['icon' => 'fa-address-book', 'title' => 'Pengaturan CP', 'link' => 'cp-admin']],
        ];
    @endphp
@endif
