...
<body class="bg-white">
    ...
    <div class="container mx-auto px-4 py-[80px] pb-[107px]">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Card 1 -->
            <div class="relative border-2 border-primary rounded-lg p-7 text-center h-40">
                <div class="absolute top-0 left-0 bg-primary text-white px-2 py-1 rounded-br-lg">
                ...
                <div class="py-4 flex flex-col items-center justify-center">
                    ...
                    <a href="{{ route('pengumumantk') }}" class="bg-primary text-white py-2 px-4 rounded hover:bg-green-800">KLIK DISINI</a>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="relative border-2 border-primary rounded-lg p-7 text-center h-40">
                ...
                <div class="py-4 flex flex-col items-center justify-center">
                    ...
                    <a href="{{ route('pengumumansd') }}" class="bg-primary text-white py-2 px-4 rounded hover:bg-green-800">KLIK DISINI</a>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="relative border-2 border-primary rounded-lg p-7 text-center h-40">
                ...
                <div class="py-4 flex flex-col items-center justify-center">
                    ...
                    <a href="{{ route('pengumumansmp') }}" class="bg-primary text-white py-2 px-4 rounded hover:bg-green-800">KLIK DISINI</a>
                </div>
            </div>
            <!-- Card 4 -->
            <div class="relative border-2 border-primary rounded-lg p-7 text-center h-40">
                ...
                <div class="py-4 flex flex-col items-center justify-center">
                    ...
                    <a href="{{ route('pengumumansma') }}" class="bg-primary text-white py-2 px-4 rounded hover:bg-green-800">KLIK DISINI</a>
                </div>
            </div>
            <!-- Card 5 -->
            <div class="relative border-2 border-primary rounded-lg p-7 text-center h-40">
