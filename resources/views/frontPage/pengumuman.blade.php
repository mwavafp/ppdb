            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="relative border-2 border-red-500 rounded-lg p-4 text-center">
                        ...
                        <a href="{{ route('pengumuman-tk') }}" class="bg-red-500 text-white py-2 px-4 rounded">KLIK
                            DISINI</a>
                    </div>
                    <!-- Card 2 -->
                    <div class="relative border-2 border-red-500 rounded-lg p-4 text-center">
                    ...
                    <div class="relative border-2 border-red-500 rounded-lg p-4 text-center">
                        ...
                        <a href="{{ route('pengumuman-smp') }}" class="bg-red-500 text-white py-2 px-4 rounded">KLIK
                            DISINI</a>
                    </div>
                    <!-- Card 4 -->
                    <div class="relative border-2 border-red-500 rounded-lg p-4 text-center">
                        ...
                        <a href="{{ route('pengumuman-sma') }}" class="bg-red-500 text-white py-2 px-4 rounded">KLIK
                            DISINI</a>
                    </div>
                    <!-- Card 5 -->
                    <div class="relative border-2 border-red-500 rounded-lg p-4 text-center">
