<x-layout>
    ...
    <body class="bg-white min-h-screen flex flex-col">
        ...
        <!-- Konten -->
        <div class="container mx-auto px-4 py-20 pb-32 flex-1">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">

                <!-- Card 1 -->
                <div class="relative border-2 border-[oklch(62.7%_0.194_149.214)] rounded-lg p-7 text-center">
                    <div
                    ...
                    <div class="py-4 flex flex-col items-center justify-center">
                        ...
                        <a href="{{ route('pengumumantk') }}"
                            class="bg-[oklch(62.7%_0.194_149.214)] text-white py-2 px-4 rounded hover:bg-green-800">
                            KLIK DISINI
                        </a>
                    </div>
                </div>
