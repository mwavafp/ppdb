...
<x-layout>
  ...
  <main class="container mx-auto mt-6">
    ...
    <div class="bg-red-600 text-white text-center py-4 rounded-md">
      <h1 class="text-xl font-bold">INFORMASI MADIN</h1>
    </div>
      ...
      <div class="flex flex-col space-y-4">
        ...
        <div class="bg-white p-6 rounded-md shadow-md">
          ...
          <ul class="space-y-2">
            ...
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Kartu Keluarga</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Data Diri Anak</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Data Diri Orang Tua</span>
            </li>
          </ul>
        </div>
      </div>
