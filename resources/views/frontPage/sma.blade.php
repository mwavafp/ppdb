...
<x-layout>
  ...
  <main class="container mx-auto mt-6">
    ...
    <div class="bg-red-600 text-white text-center py-4 rounded-md">
      <h1 class="text-xl font-bold">INFORMASI SMA</h1>
    </div>
        ...
        <div class="bg-white p-6 rounded-md shadow-md">
          ...
          <ul class="space-y-2">
            <li class="flex items-center">
              ...
              <span class="ml-2">Foto copy Ijazah di legalisir : 3 lembar  </span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto copy SKHUN di legalisir : 3 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto copy Akte Kelahiran : 3 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto copy KK di legalisir : 3 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto warna 4 x 6 : 2 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto warna 3 x 4 : 2 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto hitam putih 3 x 4 : 2 lembar</span>
            </li>
          </ul>
        </div>
      </div>
