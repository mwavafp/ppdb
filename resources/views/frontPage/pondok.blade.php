  ...
  <x-slot:title>{{$title}}</x-slot:title>
    ...
    <div class="background flex bg-white p-16"> <!-- Mengubah bg-gradient menjadi bg-white -->
        ...
        <div class="content-2 flex-1 items-center flex">
            <img src="/images/compo_pondok.jpg" alt="" class="mx-auto my-auto rounded-xl">
        </div>
    </div>
</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 m-6">
                ...
                <div class="bg-white p-6 rounded-md shadow-md">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <i class="fas fa-check text-primary mt-1">
                            </i>
                            <div class="ml-2">
                                <strong>
                                    STEP 1 - DAFTAR
                                ...
                                <p>
                                    Selesai mendaftar, pendaftar akan menerima notifikasi whatsapp untuk melanjutkan
                                    proses pembayaran
                                </p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            ...
                            <div class="ml-2">
                                ...
                                <p>
                                    Isi dan lengkapi isi formulir pendaftaran dan pilih tujuan daftar (Daycare,
                                    Playgroup, TK).
                                </p>
                            </div>
                        </li>
                ...
                <div class='flex flex-col'>
                    <div class="bg-white p-6 rounded-md shadow-md mb-4 tabel-1">
                        ...
                        <a href="/form?unit_pendidikan=PONDOK" class="bg-primary text-white py-2 px-4 rounded-md">
                            DAFTAR KLIK DISINI
                        </a>
                    </div>
