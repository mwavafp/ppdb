...
<x-layout>
  ...
  <main class="container mx-auto mt-6">
    ...
    <div class="bg-red-600 text-white text-center py-4 rounded-md">
      <h1 class="text-xl font-bold">INFORMASI PONDOK</h1>
    </div>
        ...
        <div class="bg-white p-6 rounded-md shadow-md">
          ...
          <ul class="space-y-2">
            <li class="flex items-center">
              ...
              <span class="ml-2">Foto Copy Ijazah dan SKHUN : 3 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
            ...
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto Copy KK : 3 lembar</span>
            </li>
            <li class="flex items-center">
              <i class="fas fa-check text-green-500"></i>
              <span class="ml-2">Foto 3 x 4 : 3 lembar</span>
            </li>
          </ul>
        </div>
      </div>
