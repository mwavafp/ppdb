    ...
    <div class="contact-cards-container bg-white rounded-lg shadow mx-6 my-10 p-6 h-3/6 flex items-center justify-center">
        <div class="contact-cards flex justify-center gap-20 flex-wrap">
            ...
            <div class="contact-card text-center border border-gray-300 rounded-lg shadow-md p-6 w-60 bg-white">
                ...
                <a href="https://wa.me/6289656488667?text=Assalamualaikum" target="_blank" class="contact-btn bg-reds text-white hover:scale-110 px-4 py-2 rounded mt-4 inline-block">Contact</a>
            </div>
            ...
            <div class="contact-card text-center border border-gray-300 rounded-lg shadow-md p-6 w-60 bg-white">
                ...
                <a href="https://wa.me/6289656488667?text=Assalamualaikum%2C%20Halo%20Bapak%2FIbu.%20Saya%20ingin%20bertanya%20tentang%20pendaftaran%20sekolah" target="_blank" class="contact-btn bg-reds text-white hover:scale-110 px-4 py-2 rounded mt-4 inline-block">Contact</a>
            </div>
