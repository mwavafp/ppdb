    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $index => $row) {
            DB::transaction(function () use ($row, $index) {
                ...
                // Map unit pendidikan → id_contact (pastikan sesuai tabel contact)
                $mapUnit = [
                    'tk'      => 4,
                    'sd'      => 5,
                    'smp'     => 6,
                ...
                // Cari kelas, buat kalau belum ada
                ...
                // Buat pembayaran & unit pendidikan
                ...
                if (!$hargaId) {
                    throw ValidationException::withMessages([
                        'harga' => 'Harga tidak ditemukan pada baris ' . ($index + 2),
                    ]);
                }
